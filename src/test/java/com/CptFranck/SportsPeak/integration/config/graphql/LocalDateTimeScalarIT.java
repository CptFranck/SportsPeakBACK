...
public class LocalDateTimeScalarIT {
    ...
    @Test
    public void parseValue_InvalidInputFormat_ThrowCoercingSerializeException() {
    ...
    @Test
    public void parseLiteral_ValidInputTime_Void() {
        LocalDateTime expected = LocalDateTime.now();
    ...
    @Test
    public void valueToLiteral_ValidInput_Void() {
